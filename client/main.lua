...
function OpenMobileFoodTruckActionsMenu()
	...
	ESX.UI.Menu.Open(
		'defaultd', GetCurrentResourceName(), 'mobile_foodtruck_actions',
		{
			title    = _U('foodtruck'),
			elements = {
				{label = _U('foodtruck_serviceon'), value = 'foodtruck_serviceon'},
				{label = _U('foodtruck_serviceoff'), value = 'foodtruck_serviceoff'},
		...
		function(data, menu)
			...
			if data.current.value == 'foodtruck_serviceon' then
				
				TriggerServerEvent("player:serviceOn", "foodtruck")
				
			end 
			  
			if data.current.value == 'foodtruck_serviceoff' then
				
				TriggerServerEvent("player:serviceOff", "foodtruck")
			...
			elseif data.current.value == 'gears' then
				ESX.UI.Menu.Open(
					'defaultd', GetCurrentResourceName(), 'foodtruck_gears',
					{
						title    = _U('gear'),
						elements = {
